...
<head>
    ...
    <title>Lungcancer Database | Data</title>
                                        ...
                                        <table id="search-results" class="table table-bordered">
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($override->AllTables() as $tables) {
                                                    ...
                                                    if (
                                                        $tables['Tables_in_lungcancer'] == 'clients' ||
                                                        $tables['Tables_in_lungcancer'] == 'kap' ||
                                                        $tables['Tables_in_lungcancer'] == 'history' ||
                                                        $tables['Tables_in_lungcancer'] == 'results' ||
                                                        $tables['Tables_in_lungcancer'] == 'classification' ||
                                                        $tables['Tables_in_lungcancer'] == 'outcome' ||
                                                        $tables['Tables_in_lungcancer'] == 'economic' ||
                                                        $tables['Tables_in_lungcancer'] == 'visit'
                                                        // $tables['Tables_in_lungcancer'] == 'visit'
                                                    ) {
                                                ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input type="hidden" name="table_id" value="<?= $tables['Tables_in_lungcancer']; ?>">
                                                                <div class="form-check">
                                                                    <input class="form-check-input" type="checkbox" name="table_name[]" id="table_name[]" value="<?= $tables['Tables_in_lungcancer']; ?>" <?php if ($tables['Tables_in_lungcancer'] != '') {
                                                                                                                                                                                                        echo 'checked';
                                                                                                                                                                                                    } ?>>
                                                                    <label class="form-check-label"><?= $tables['Tables_in_lungcancer']; ?></label>
                                                                </div>
                                                            </td>
                                                            <td class="table-user">
                                                                <?= $override->getCount($tables['Tables_in_lungcancer'], 'status', 1); ?>
                                                            </td>
                                                            <td class="table-user text-center">
                                                                <form method="post">
                                                                    <input type="hidden" name="data" value="<?= $x; ?>">
                                                                    <input type="hidden" name="table" value="<?= $tables['Tables_in_lungcancer']; ?>">
                                                                    ...
                                                                    <?php if ($user->data()->position != 5) { ?>
                                                                        ...
                                                                        <hr>
                                                                        <!-- <a href="dictionary.php?table=<?= $tables['Tables_in_lungcancer'] ?>" role=" button" class="btn btn-info"> Download Data Dictionary</a> -->

                                                                        <!-- <button type="submit" name="download_dictionary">Download Data Dictionary</button>&nbsp;&nbsp;&nbsp; -->
                                                                        <a href="data.php?id=2&table=<?= $tables['Tables_in_lungcancer'] ?>" role=" button" class="btn btn-info"> View Recoreds </a>
                                                                    <?php } ?>
                                                                </form>
                                                                <hr>
                                                                <?php
                                                                // if ($user->data()->position != 5) {
                                                                ?>
                                                                    <a href="dictionary_<?= $tables['Tables_in_lungcancer'] ?>.php?table=<?= $tables['Tables_in_lungcancer'] ?>" role=" button" class="btn btn-info"> Download <?= $tables['Tables_in_lungcancer'] ?> Dictionary </a>
                                                                    <!-- <form action="dictionary_<?= $tables['Tables_in_lungcancer'] ?>.php?table=<?= $tables['Tables_in_lungcancer'] ?>" method="GET">

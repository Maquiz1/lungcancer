...
foreach ($clients as $client) {
    ...
    if ($client['eligible'] == 1) {
        if ($client['site_id'] == 1 || $client['site_id'] == 2 || $client['site_id'] == 4 || $client['site_id'] == 5) {
        ...
        }elseif($client['site_id'] == 3 && $client['sex'] == 1){
            if ($screening['consented'] == 1) {
                $consent = 'Called';
            } elseif ($screening['consented'] == 2) {
                $consent = 'No';
        ...
        } elseif ($client['site_id'] == 3 && $client['sex'] == 2) {
            if ($client['date_registered'] >= '2024-06-20') {
                if ($screening['consented'] == 1) {
                    $consent = 'Called';
                } elseif ($screening['consented'] == 2) {
                    $consent = 'No';
